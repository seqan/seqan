...
// The class wraps up the inflate method of the zlib library 1.1.4 https://www.gzip.org/zlib/
...
// The class wraps up the deflate method of the zlib library 1.1.4 https://www.gzip.org/zlib/
