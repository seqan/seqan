...
If none of the following options are selected the version update feature is activated by default, but requires the user to opt-in.

  =================================  ==========================================
            Cmake Option                                Description
  =================================  ==========================================
  ``-DSEQAN_VERSION_CHECK_OPT_OUT``  Turn update feature on but make it opt-out.
