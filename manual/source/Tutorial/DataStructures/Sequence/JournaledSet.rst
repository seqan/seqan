...
.. _tutorial-datastructures-sequences-data-journaling:
...
Prerequisites
  :ref:`tutorial-datastructures-sequences`, :ref:`tutorial-datastructures-sequences-string-sets`, :ref:`tutorial-datastructures-sequences-iterators`
...
.. container:: assignment
   ...
   Objective
     Download the fasta file :download:`sequences.fasta <../../InputOutput/sequences.fasta>` which contains some DNA sequences.
...
.. container:: assignment
   ...
   Objective
     ...
     You can find additional material to this topic in the :ref:`tutorial-algorithms-pattern-matching` Tutorial.
