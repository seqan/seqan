...
.. includefrags:: extras/demos/tutorial/realign/step1.cpp

The output of the program is as follows:

.. includefrags:: extras/demos/tutorial/realign/step1.cpp.stdout
...
.. includefrags:: extras/demos/tutorial/realign/step2.cpp

Here is the program's output.
The reference pseudo-read is here shown as the first read (second row) below the reference (first row).

.. includefrags:: extras/demos/tutorial/realign/step2.cpp.stdout
