...
.. _tutorial-getting-started-setup-seqan-windows-visual-studio:
...
.. tip::
    ...
    * If you plan to use different versions of Visual Studio then follow :ref:`how-to-recipes-use-parallel-build-directories`.
...
* If you have not done so, install optional dependencies of SeqAn.
  To read and write compressed files, follow :ref:`how-to-recipes-install-contribs-on-windows`.
