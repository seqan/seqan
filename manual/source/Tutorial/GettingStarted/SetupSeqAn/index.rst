...
.. _tutorial-getting-started-setup-seqan:
...
This chapter gives you the necessary steps to setup SeqAn for you favorbale development environment:
...
Linux using
  * :ref:`Makefiles <tutorial-getting-started-setup-seqan-linux-makefiles>`
  * :ref:`Eclipse <tutorial-getting-started-setup-seqan-linux-eclipse>`

Mac Os X
  * :ref:`Makefiles <tutorial-getting-started-setup-seqan-mac-makefiles>`
  * :ref:`Xcode <tutorial-getting-started-setup-seqan-mac-xcode>`

Windows
  * :ref:`Visual Studio <tutorial-getting-started-setup-seqan-windows-visual-studio>`
...
.. rubric:: :rubric-heading1:`Relevant How-Tos`

Although slightly more advanced than "getting started", the following
How-Tos apply to setting up your build environment:

* :ref:`how-to-recipes-use-parallel-build-directories`
* :ref:`how-to-recipes-install-contribs-on-windows`
* :ref:`internal-build-manual-integration-with-your-own-build-system`
