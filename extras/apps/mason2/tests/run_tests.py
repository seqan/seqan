...
def main(source_base, binary_base):
    ...
    conf = app_tests.TestConf(
        ...
        args=['-l', '1000',
              '-o', ph.outFile('genome.test1.fa'),
              ],
        redir_stdout=ph.outFile('genome.test1.stdout'),
        redir_stderr=ph.outFile('genome.test1.stderr'),
        to_diff=[(ph.inFile('genome.test1.fa'),
                  ph.outFile('genome.test1.fa')),
    ...
    conf = app_tests.TestConf(
        ...
        args=['-s', '1',
              '-l', '1000',
              '-l', '100',
              '-o', ph.outFile('genome.test2.fa'),
              ],
        redir_stdout=ph.outFile('genome.test2.stdout'),
        redir_stderr=ph.outFile('genome.test2.stderr'),
        to_diff=[(ph.inFile('genome.test2.fa'),
                  ph.outFile('genome.test2.fa')),
    ...
    conf = app_tests.TestConf(
        ...
        args=['--seed', '33',
              '-i', ph.inFile('random.fa'),
              '-o', ph.outFile('random_meth1.fa'),
              ],
        redir_stdout=ph.outFile('methylation.test1.stdout'),
        redir_stderr=ph.outFile('methylation.test1.stderr'),
        to_diff=[(ph.inFile('methylation.test1.fa'),
                  ph.outFile('methylation.test1.fa')),
    ...
    conf = app_tests.TestConf(
        ...
        args=['-ir', ph.inFile('random.fa'),
              '-n', '2',
              '-ov', ph.outFile('random_var1.vcf'),
              '-of', ph.outFile('random_var1.fa'),
              '--snp-rate', '0.001',
              ...
              '--max-sv-size', '100',
              '--methylation-levels',
              '--meth-fa-out', ph.outFile('random_var1_meth.fa'),
        ...
        to_diff=[(ph.inFile('random_var1.vcf'),
                  ...
                  transforms),
                 (ph.inFile('random_var1.fa'),
                  ph.outFile('random_var1.fa')),
                 (ph.inFile('random_var1_bp.txt'),
                  ph.outFile('random_var1_bp.txt')),
                 (ph.inFile('random_var1_meth.fa'),
                  ph.outFile('random_var1_meth.fa')),
    ...
    conf = app_tests.TestConf(
        ...
        args=['-ir', ph.inFile('random.fa'),
              ...
              '--max-sv-size', '100',
              '--methylation-levels',
              '--meth-fa-in', ph.inFile('random_meth1.fa'),
              '--meth-fa-out', ph.outFile('random_var2_meth.fa'),
        ...
        to_diff=[(ph.inFile('random_var2.vcf'),
                  ...
                  transforms),
                 (ph.inFile('random_var2.fa'),
                  ph.outFile('random_var2.fa')),
                 (ph.inFile('random_var2_bp.txt'),
                  ph.outFile('random_var2_bp.txt')),
                 (ph.inFile('random_var2_meth.fa'),
                  ph.outFile('random_var2_meth.fa')),
    ...
    conf = app_tests.TestConf(
        ...
        to_diff=[(ph.inFile('random_var3.vcf'),
                  ...
                  transforms),
                 (ph.inFile('random_var3.fa'),
                  ph.outFile('random_var3.fa')),
    ...
    conf = app_tests.TestConf(
        ...
        args=['-ir', ph.inFile('random.fa'),
              ...
              '-o', ph.outFile('materializer.random_var1.fa'),
              ],
        redir_stdout=ph.outFile('materializer.random_var1.stdout'),
        redir_stderr=ph.outFile('materializer.random_var1.stderr'),
        to_diff=[(ph.inFile('random_var1.fa'),
                  ph.outFile('materializer.random_var1.fa')),
    ...
    conf = app_tests.TestConf(
        ...
        args=['-ir', ph.inFile('random.fa'),
              ...
              '-o', ph.outFile('materializer.random_var2.fa'),
              '--meth-fa-in', ph.inFile('random_meth1.fa'),
              '--meth-fa-out', ph.outFile('materializer.random_meth2.fa'),
              ],
        ...
        to_diff=[(ph.inFile('random_var1.fa'),
                  ph.outFile('materializer.random_var1.fa')),
                 (ph.inFile('random_var2_meth.fa'),
                  ph.outFile('materializer.random_meth2.fa'),
                  transforms),
